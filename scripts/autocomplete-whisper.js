Hooks.on('renderSidebarTab', (app, html, data) => {
    ...
    function autocomplete(match) {
      ...
      var charactersAfter = isArrayOfTargets ? ", " : " ";
      // interesting quirk: if the whisper target has a space in it, the @ syntax only works if the target name is wrapped in [].
